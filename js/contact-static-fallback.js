  ...
  (event) => {
    ...
    const body = encodeURIComponent(
      [
        ...
        `Diện tích dự kiến: ${payload.buildArea || ""}`,
        `Số tầng dự kiến: ${payload.floors || ""}`,
        `Loại công trình: ${payload.service || ""}`,
        `Mức đầu tư: ${payload.budget || ""}`,
        `Thời gian khởi công: ${payload.startTime || ""}`,
        `Hình thức liên hệ mong muốn: ${payload.preferredContact || ""}`,
        "",
